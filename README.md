I collect apartment listings from Divar's API (a popular Iranian classified ads platform), apply regression and clustering models, and visualize the results on a map.
